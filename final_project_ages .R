...
library(tidyverse)
        ...
        #not sure about these - but might add some colour and quick perspective

iron(
  waffle(c("Members" = 1, "Non-Members" = 49), rows = 10, keep = FALSE, colors = c("#FDE725", "#440154"), legend_pos = "hidden" )
)
